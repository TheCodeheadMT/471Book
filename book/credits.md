...
> `Phan, Tiffany M., Todd, Michael C., Payne, Joseph M.` (`2026`) _`CS 471 Artificial Intelligence`_. `https://thecodeheadmt.github.io/471Book/main/intro.html`. Source files at `https://github.com/TheCodeheadMT/471Book`. CC BY 4.0.

You can refer to individual sections within this book using the format below:

> `L27: ML Foundations`. In `Phan, Tiffany M., Todd, Michael C., Payne, Joseph M.` (`2026`) _`CS 471 Artificial Intelligence`_. `https://thecodeheadmt.github.io/471Book/main/lessons/27/mlfoundations.html#`. Source files at `https://github.com/TheCodeheadMT/471Book`. CC BY 4.0.
...
This website is written in markdown and jupyter notebooks files, which are converted to html using tools from [TeachBooks](https://teachbooks.io/). The files are stored on a [public GitHub repository](`https://github.com/TheCodeheadMT/471Book`). The website can be viewed at `https://thecodeheadmt.github.io/471Book/main/intro.html`.
